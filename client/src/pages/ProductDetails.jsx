    ...
    return product && (
        <div className="mt-12">
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <button className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-green-400 transition hover:text-taupe-50" onClick={()=>{navigate('/products');scrollTo(0,0)}}>
                    See More
                </button>
            </div>
